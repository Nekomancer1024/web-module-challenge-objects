...
*/
console.log('task 1b: ', createMenuItem('Pumpkin Spice Latte', 8, 'Drinks'));
console.log('task 1b: ', createMenuItem('White Chocolate Mocha', 8, 'Drinks'));
console.log('task 1b: ', createMenuItem('Apple Fritter', 2, 'Bakery'));
